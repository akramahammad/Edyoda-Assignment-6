...

{
    ...
    <div class="gridItem">
        <div class="card">
            <img class="cardImg" src="https://images.unsplash.com/photo-1519681393784-d120267933ba?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=2250&amp;q=80" alt="Snowy Mountains">
...
function createcard(thumbnail, imagedesc, headertext, desc) {
...
for (var i = 0; i < cards.length; i++) {
    createcard(cards[i].imgUrl, cards[i].imgAlt, cards[i].header, cards[i].description);
}